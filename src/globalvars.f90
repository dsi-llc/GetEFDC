MODULE GLOBALVARS
 ...
 INTEGER(4),PARAMETER:: NTSWQVM=40  !VB NTSWQVM CHANGED FROM 22 TO 23 TO ACCOMODATE CO2 & MAC
 ...
 INTEGER(4),PARAMETER::UTEC6 = 54
 INTEGER(4),PARAMETER::USDI =  101
 INTEGER(4),PARAMETER::USDO =  102
...
!**************************************************************************
 ...
 ! *** EESWAN ***
  ...
  CHARACTER(200)::FSMPON_G1
  CHARACTER(200)::FSMPON_G2
  CHARACTER(200)::FSMPON_G3
  CHARACTER(200)::FSMPOP_G1
  CHARACTER(200)::FSMPOP_G2
  CHARACTER(200)::FSMPOP_G3
  CHARACTER(200)::FSMPOC_G1
  CHARACTER(200)::FSMPOC_G2
  CHARACTER(200)::FSMPOC_G3
  CHARACTER(200)::FSMDFN_G1
  CHARACTER(200)::FSMDFN_G2
  CHARACTER(200)::FSMDFN_G3
  CHARACTER(200)::FSMDFP_G1
  CHARACTER(200)::FSMDFP_G2
  CHARACTER(200)::FSMDFP_G3
  CHARACTER(200)::FSMDFC_G1
  CHARACTER(200)::FSMDFC_G2
  CHARACTER(200)::FSMDFC_G3
  CHARACTER(200)::FSM1NH4  
  CHARACTER(200)::FSM2NH4  
  CHARACTER(200)::FSM1NO3  
  CHARACTER(200)::FSM2NO3  
  CHARACTER(200)::FSM1PO4  
  CHARACTER(200)::FSM2PO4  
  CHARACTER(200)::FSM1H2S  
  CHARACTER(200)::FSM2H2S  
  CHARACTER(200)::FSM1SI   
  CHARACTER(200)::FSM2SI   
  CHARACTER(200)::FSMPSI   
  CHARACTER(200)::FSMBST   
  CHARACTER(200)::FSMT     
  CHARACTER(200)::FSMCSOD  
  CHARACTER(200)::FSMNSOD  
  CHARACTER(200)::FWQBFNH4 
  CHARACTER(200)::FWQBFNO3 
  CHARACTER(200)::FWQBFO2  
  CHARACTER(200)::FWQBFCOD 
  CHARACTER(200)::FWQBFPO4D
  CHARACTER(200)::FWQBFSAD
  
  CHARACTER(200)::DSMPON_G1
  CHARACTER(200)::DSMPON_G2
  CHARACTER(200)::DSMPON_G3
  CHARACTER(200)::DSMPOP_G1
  CHARACTER(200)::DSMPOP_G2
  CHARACTER(200)::DSMPOP_G3
  CHARACTER(200)::DSMPOC_G1
  CHARACTER(200)::DSMPOC_G2
  CHARACTER(200)::DSMPOC_G3
  CHARACTER(200)::DSMDFN_G1
  CHARACTER(200)::DSMDFN_G2
  CHARACTER(200)::DSMDFN_G3
  CHARACTER(200)::DSMDFP_G1
  CHARACTER(200)::DSMDFP_G2
  CHARACTER(200)::DSMDFP_G3
  CHARACTER(200)::DSMDFC_G1
  CHARACTER(200)::DSMDFC_G2
  CHARACTER(200)::DSMDFC_G3
  CHARACTER(200)::DSM1NH4  
  CHARACTER(200)::DSM2NH4  
  CHARACTER(200)::DSM1NO3  
  CHARACTER(200)::DSM2NO3  
  CHARACTER(200)::DSM1PO4  
  CHARACTER(200)::DSM2PO4  
  CHARACTER(200)::DSM1H2S  
  CHARACTER(200)::DSM2H2S  
  CHARACTER(200)::DSM1SI   
  CHARACTER(200)::DSM2SI   
  CHARACTER(200)::DSMPSI   
  CHARACTER(200)::DSMBST   
  CHARACTER(200)::DSMT     
  CHARACTER(200)::DSMCSOD  
  CHARACTER(200)::DSMNSOD  
  CHARACTER(200)::DWQBFNH4 
  CHARACTER(200)::DWQBFNO3 
  CHARACTER(200)::DWQBFO2  
  CHARACTER(200)::DWQBFCOD 
  CHARACTER(200)::DWQBFPO4D
  CHARACTER(200)::DWQBFSAD
  
  CHARACTER(200)::TSSDF(39)
  CHARACTER(200)::DOMSDF(39)
  ...
  REAL(4),   ALLOCATABLE ::BDELTA(:,:)  
  REAL(4),   ALLOCATABLE ::BEDLINIT(:,:)   
  ...
  REAL(4),   ALLOCATABLE ::  WDENS(:)
  REAL(4),   ALLOCATABLE ::  BEDSHRA(:)
  ...
  REAL(4),   ALLOCATABLE ::HBEDA(:)
  REAL(4),   ALLOCATABLE ::BDELTAA(:)
  REAL(4),   ALLOCATABLE ::BDENBEDA(:)
  REAL(4),   ALLOCATABLE ::PORBEDA(:)
  
  REAL(4),   ALLOCATABLE ::TOXBA(:,:,:)
  REAL(4),   ALLOCATABLE ::SEDBA(:,:,:)  
  REAL(4),   ALLOCATABLE ::SNDBA(:,:,:)
  ...
  ! *** Sediment diagenesis
  REAL(4),ALLOCATABLE,DIMENSION(:,:)   :: SMPOC      !< Particulate organic Carbon     in the sediments
  REAL(4),ALLOCATABLE,DIMENSION(:,:)   :: SMPOP      !< Particulate organic Phosphorus in the sediments 
  REAL(4),ALLOCATABLE,DIMENSION(:,:)   :: SMPON      !< Particulate organic Nitrogen   in the sediments
  REAL(4),ALLOCATABLE,DIMENSION(:,:) :: SMDFC  !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:,:) :: SMDFN  !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:,:) :: SMDFP  !< WATER QUALITY MODEL VARIABLE
  
  
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SMPSI       !< Sediment Silica  
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM1H2S !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM1NH4 !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM1NO3 !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM1PO4 !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM2PO4 !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM1SI  !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM2H2S !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM2NH4 !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM2SI  !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SMBST  !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SMCSOD !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SM2NO3 !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SMT    !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: SMNSOD !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: WQBFNH4    !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: WQBFNO3    !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: WQBFO2    !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: WQBFCOD    !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: WQBFPO4D    !< WATER QUALITY MODEL VARIABLE
  REAL(4),ALLOCATABLE,DIMENSION(:)   :: WQBFSAD    !< WATER QUALITY MODEL VARIABLE
