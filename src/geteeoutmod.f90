...
999 STOP ' **** OPENING EE_WC.OUT ERROR'
    ...
    ELSEIF(ITEM(1:3)=='BEL') THEN
        ...
        DO N=1,NLOC
            ...
            VAL(N) = BELV(L)
        ENDDO
        WRITE(UCVPRF(2),SFMT) (VAL(N),N=1,NLOC)
    ENDIF
